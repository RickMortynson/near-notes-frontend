    ...
    <div className='relative flex select-none flex-col items-center text-skin-base'>
      {user.loggedIn ? (
        <>
          ...
          {showDropDown && (
            <div className='absolute top-8 w-full rounded-md border-slate-300 bg-skin-ternary text-sm shadow-lg  ring-2 ring-slate-200 transition-shadow children:px-2 children:py-1'>
